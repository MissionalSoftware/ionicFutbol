angular.module('futbol')
  ...
  .factory('Games', function() {
    ...
    var games = [
      { id: 1, name: 'vs. Australia', date: '', times: { start: 0, mid: 0, end: 0}},
      { id: 2, name: 'vs. Spain', date: '', times: { start: 0, mid: 0, end: 0}},
      { id: 3, name: 'vs. Germany', date: '', times: { start: 0, mid: 0, end: 0}}
    ];
